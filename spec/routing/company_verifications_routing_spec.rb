...
RSpec.describe CompanyVerificationsController, type: :routing do
  describe "routing" do
    ...
    it "routes to #update via PUT" do
      expect(put: "/company_verifications/1").to route_to("company_verifications#update", id: "1")
    end

    it "routes to #update via PATCH" do
      expect(patch: "/company_verifications/1").to route_to("company_verifications#update", id: "1")
    end

    it "routes to #destroy" do
      expect(delete: "/company_verifications/1").to route_to("company_verifications#destroy", id: "1")
    end
  end
end
